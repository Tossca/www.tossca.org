<div class="fold--intro editor--content editor--content__consider-margins">
  <div class="roles js--roles">
    <ul class="tabs--list roles--tabs mobile__hidden">
      <li>
        <a href="#init-company">Init. Unternehmen</a>
      </li>
      <li>
        <a href="#governance">Projektverantwortlicher</a>
      </li>
      <li>
        <a href="#license">Lizenz</a>
      </li>
      <li>
        <a href="#contrib-company">Unternehmen</a>
      </li>
      <li>
        <a href="#individual">Indiv. Kontributor</a>
      </li>
    </ul>
    <figure>
      <?php
